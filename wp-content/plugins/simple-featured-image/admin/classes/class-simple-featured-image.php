...
class WP_Simple_Featured_Image{
    ...
    public function settings_menu(){
        add_submenu_page(
            'options-general.php',
            __( 'SFI Settings', 'wp-simple-featured-image' ),
            __( 'SFI Settings', 'wp-simple-featured-image' ),
            'manage_options',
            'wpsfi-settings',
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" name="wpsfi_taxonomy[]" value="<?php echo $key; ?>" <?php echo ( in_array( $key, $wpsfi_post_type ) ) ? 'checked' : '' ; ?>> <?php echo $value; ?><br/>
