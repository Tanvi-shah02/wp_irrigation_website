...
<div class="container-xl py-5"> 
   <div class="card-border-0 shadow">
    ...
    <h6 class="text-center mb-3">You can Call Us,Email Us or Visit Personally</h6>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-5 col-xl-5">
                            ...
                            <img src="https://polysilirrigation.com/wp-content/themes/polysil/images/assets/dealer-inquiry.png" alt="Dealer Inquiry" class="img-fluid">
                                </div>
                        </div>
    ...
    <div class="contact_form pt-3">
        <?php echo do_shortcode('[contact-form-7 id="464" title="Dealer Inquiry"]')?>
    </div>
