<?php
/**
 * Template Name: employee_month
 */
?>
<?php get_header(); ?>

<?php
$month = (isset($_GET['t']) && ($_GET['t'] > 0 && $_GET['t'] <= 12)) ? $_GET['t'] : 0;
$year = (isset($_GET['y']) && $_GET['y'] > 0) ? $_GET['y'] : 0;


$args = array(
    's' => (!empty($_REQUEST["search"])?$_REQUEST["search"]:''),
    'post_type'  => 'employee_month' ,
    'orderby' => array(
        'date' =>'DESC',
    ),
    'posts_per_page'      => -1,
...
<div class="entry-content service-content">
        <form name="form" action="" method="get">
            <div class="row mb-4">
                ...
                <select class="form-control custom-select" name="t" id="month">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-control custom-select" name="y" id='date-dropdown'>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
                            <div class="news-item wow fadeInUp h-100">
                                <div class="card border-0 shadow h-100 mb-3">
                                    ...
                                    <?php
                                    $categories = get_the_terms($post->ID, 'employee_month_cat');
                                    //echo $categories; 
                                     if ( ! empty( $categories ) ) {
                                         ?>
